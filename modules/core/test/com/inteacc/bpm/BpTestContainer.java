...
public class BpTestContainer extends TestContainer {

    public BpTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/inteacc/bpm/app.properties",
    ...
    public static class Common extends BpTestContainer {

        public static final BpTestContainer.Common INSTANCE = new BpTestContainer.Common();
